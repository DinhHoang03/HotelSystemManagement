package com.humg.HotelSystemManagement.modules.auth_service.configs; // Khai báo package để tổ chức mã nguồn theo cấu trúc thư mục

import com.fasterxml.jackson.databind.ObjectMapper; // Import ObjectMapper để chuyển đổi đối tượng Java thành JSON
import com.humg.HotelSystemManagement.utils.APIResponse; // Import APIResponse, một DTO dùng để định dạng phản hồi API
import com.humg.HotelSystemManagement.exceptions.enums.AppErrorCode; // Import enum AppErrorCode chứa các mã lỗi ứng dụng
