package com.humg.HotelSystemManagement.exceptions;
...
import com.humg.HotelSystemManagement.exceptions.enums.ValidationErrorCode;
...
public class GlobalExceptionHandler {
    ...
    ResponseEntity<APIResponse<Object>> handleValidationError(MethodArgumentNotValidException e) {
        ...
        for (FieldError error : e.getBindingResult().getFieldErrors()) {
            ...
            ValidationErrorCode validationErrorCode = getErrorCode(errorCode);
    ...
    private ValidationErrorCode getErrorCode(String code) {
    ...
    ResponseEntity<APIResponse> accessDeniedException(AccessDeniedException e) {
        ...
        return ResponseEntity
                .status(appErrorCode.getHttpStatusCode())
                .body(APIResponse.builder()
                        .code(appErrorCode.getCode())
                        .message(appErrorCode.getMessage())
                        .build()
                );
    }
