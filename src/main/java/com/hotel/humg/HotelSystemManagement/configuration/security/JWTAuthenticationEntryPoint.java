package com.hotel.humg.HotelSystemManagement.configuration.security; // Khai báo package để tổ chức mã nguồn theo cấu trúc thư mục

import com.fasterxml.jackson.databind.ObjectMapper; // Import ObjectMapper để chuyển đổi đối tượng Java thành JSON
import com.hotel.humg.HotelSystemManagement.dto.response.APIResponse; // Import APIResponse, một DTO dùng để định dạng phản hồi API
import com.hotel.humg.HotelSystemManagement.exception.enums.AppErrorCode; // Import enum AppErrorCode chứa các mã lỗi ứng dụng
